...
// p and g not needed for approx region except bit7 carry
wire [7:0] p0, g0;
wire [31:0] C;
...
assign s1_cp[10] = p[10] & p[9];
assign s1_cg[10] = g[10] | (p[10] & g[9]);

assign s1_cp[11] = p[11] & p[10];
assign s1_cg[11] = g[11] | (p[11] & g[10]);

assign s1_cp[12] = p[12] & p[11];
assign s1_cg[12] = g[12] | (p[12] & g[11]);

assign s1_cp[13] = p[13] & p[12];
assign s1_cg[13] = g[13] | (p[13] & g[12]);

assign s1_cp[14] = p[14] & p[13];
assign s1_cg[14] = g[14] | (p[14] & g[13]);

assign s1_cp[15] = p[15] & p[14];
assign s1_cg[15] = g[15] | (p[15] & g[14]);

assign s1_cp[16] = p[16] & p[15];
assign s1_cg[16] = g[16] | (p[16] & g[15]);

assign s1_cp[17] = p[17] & p[16];
assign s1_cg[17] = g[17] | (p[17] & g[16]);

assign s1_cp[18] = p[18] & p[17];
assign s1_cg[18] = g[18] | (p[18] & g[17]);
...
assign s1_cp[31] = p[31] & p[30];
assign s1_cg[31] = g[31] | (p[31] & g[30]);
...
assign s2_cp[10] = s1_cp[10] & s1_cp[8];
assign s2_cg[10] = s1_cg[10] | (s1_cp[10] & s1_cg[8]);

assign s2_cp[11] = s1_cp[11] & s1_cp[9];
assign s2_cg[11] = s1_cg[11] | (s1_cp[11] & s1_cg[9]);

assign s2_cp[12] = s1_cp[12] & s1_cp[10];
assign s2_cg[12] = s1_cg[12] | (s1_cp[12] & s1_cg[10]);

assign s2_cp[13] = s1_cp[13] & s1_cp[11];
assign s2_cg[13] = s1_cg[13] | (s1_cp[13] & s1_cg[11]);

assign s2_cp[14] = s1_cp[14] & s1_cp[12];
assign s2_cg[14] = s1_cg[14] | (s1_cp[14] & s1_cg[12]);

assign s2_cp[15] = s1_cp[15] & s1_cp[13];
assign s2_cg[15] = s1_cg[15] | (s1_cp[15] & s1_cg[13]);

assign s2_cp[16] = s1_cp[16] & s1_cp[14];
assign s2_cg[16] = s1_cg[16] | (s1_cp[16] & s1_cg[14]);

assign s2_cp[17] = s1_cp[17] & s1_cp[15];
assign s2_cg[17] = s1_cg[17] | (s1_cp[17] & s1_cg[15]);

assign s2_cp[18] = s1_cp[18] & s1_cp[16];
assign s2_cg[18] = s1_cg[18] | (s1_cp[18] & s1_cg[16]);
...
assign s3_cp[12] = s2_cp[12] & s2_cp[8];
assign s3_cg[12] = s2_cg[12] | (s2_cp[12] & s2_cg[8]);

assign s3_cp[13] = s2_cp[13] & s2_cp[9];
assign s3_cg[13] = s2_cg[13] | (s2_cp[13] & s2_cg[9]);

assign s3_cp[14] = s2_cp[14] & s2_cp[10];
assign s3_cg[14] = s2_cg[14] | (s2_cp[14] & s2_cg[10]);

assign s3_cp[15] = s2_cp[15] & s2_cp[11];
assign s3_cg[15] = s2_cg[15] | (s2_cp[15] & s2_cg[11]);

assign s3_cp[16] = s2_cp[16] & s2_cp[12];
assign s3_cg[16] = s2_cg[16] | (s2_cp[16] & s2_cg[12]);

assign s3_cp[17] = s2_cp[17] & s2_cp[13];
assign s3_cg[17] = s2_cg[17] | (s2_cp[17] & s2_cg[13]);

assign s3_cp[18] = s2_cp[18] & s2_cp[14];
assign s3_cg[18] = s2_cg[18] | (s2_cp[18] & s2_cg[14]);

assign s3_cp[19] = s2_cp[19] & s2_cp[15];
assign s3_cg[19] = s2_cg[19] | (s2_cp[19] & s2_cg[15]);

assign s3_cp[20] = s2_cp[20];
assign s3_cg[20] = s2_cg[20];

assign s3_cp[21] = s2_cp[21];
assign s3_cg[21] = s2_cg[21];

assign s3_cp[22] = s2_cp[22];
assign s3_cg[22] = s2_cg[22];

assign s3_cp[23] = s2_cp[23];
assign s3_cg[23] = s2_cg[23];

assign s3_cp[24] = s2_cp[24] & s2_cp[23];
assign s3_cg[24] = s2_cg[24] | (s2_cp[24] & s2_cg[23]);

assign s3_cp[25] = s2_cp[25] & s2_cp[23];
assign s3_cg[25] = s2_cg[25] | (s2_cp[25] & s2_cg[23]);

assign s3_cp[26] = s2_cp[26] & s2_cp[23];
assign s3_cg[26] = s2_cg[26] | (s2_cp[26] & s2_cg[23]);

assign s3_cp[27] = s2_cp[27] & s2_cp[23];
assign s3_cg[27] = s2_cg[27] | (s2_cp[27] & s2_cg[23]);

assign s3_cp[28] = s2_cp[28];
assign s3_cg[28] = s2_cg[28];

assign s3_cp[29] = s2_cp[29];
assign s3_cg[29] = s2_cg[29];

assign s3_cp[30] = s2_cp[30];
assign s3_cg[30] = s2_cg[30];

assign s3_cp[31] = s2_cp[31];
assign s3_cg[31] = s2_cg[31];
...
assign s4_cp[16] = s3_cp[16] & s3_cp[9];
assign s4_cg[16] = s3_cg[16] | (s3_cp[16] & s3_cg[9]);

assign s4_cp[17] = s3_cp[17] & s3_cp[9];
assign s4_cg[17] = s3_cg[17] | (s3_cp[17] & s3_cg[9]);

assign s4_cp[18] = s3_cp[18] & s3_cp[11];
assign s4_cg[18] = s3_cg[18] | (s3_cp[18] & s3_cg[11]);

assign s4_cp[19] = s3_cp[19] & s3_cp[11];
assign s4_cg[19] = s3_cg[19] | (s3_cp[19] & s3_cg[11]);

assign s4_cp[20] = s3_cp[20];
assign s4_cg[20] = s3_cg[20];

assign s4_cp[21] = s3_cp[21];
assign s4_cg[21] = s3_cg[21];

assign s4_cp[22] = s3_cp[22];
assign s4_cg[22] = s3_cg[22];

assign s4_cp[23] = s3_cp[23];
assign s4_cg[23] = s3_cg[23];
...
assign s4_cp[28] = s3_cp[28] & s3_cp[27];
assign s4_cg[28] = s3_cg[28] | (s3_cp[28] & s3_cg[27]);

assign s4_cp[29] = s3_cp[29] & s3_cp[27];
assign s4_cg[29] = s3_cg[29] | (s3_cp[29] & s3_cg[27]);

assign s4_cp[30] = s3_cp[30] & s3_cp[27];
assign s4_cg[30] = s3_cg[30] | (s3_cp[30] & s3_cg[27]);

assign s4_cp[31] = s3_cp[31] & s3_cp[27];
assign s4_cg[31] = s3_cg[31] | (s3_cp[31] & s3_cg[27]);

//------------------------------------------------------------
// For bit 8 → next carry is C9
//------------------------------------------------------------

assign C[8]  = s4_cg[8]  ;
assign C[9]  = s4_cg[9]  ;
assign C[10] = s4_cg[10] ;
assign C[11] = s4_cg[11] ;
assign C[12] = s4_cg[12] ;
assign C[13] = s4_cg[13] ;
assign C[14] = s4_cg[14] ;
assign C[15] = s4_cg[15] ;
assign C[16] = s4_cg[16] ;
assign C[17] = s4_cg[17] ;
assign C[18] = s4_cg[18] ;
assign C[19] = s4_cg[19] ;
assign C[20] = s4_cg[20] ;
assign C[21] = s4_cg[21] ;
assign C[22] = s4_cg[22] ;
assign C[23] = s4_cg[23] ;
assign C[24] = s4_cg[24] ;
assign C[25] = s4_cg[25] ;
assign C[26] = s4_cg[26] ;
assign C[27] = s4_cg[27] ;
assign C[28] = s4_cg[28] ;
assign C[29] = s4_cg[29] ;
assign C[30] = s4_cg[30] ;
assign C[31] = s4_cg[31] ;

assign cout  = s4_cg[31] ;

//============================================================
//  FINAL SUM COMPUTATION
//============================================================

// Approximate sum: OR gate
assign s[0] = p0[0] | C[0];
assign s[1] = p0[1] | C[1];
assign s[2] = p0[2] | C[2];
assign s[3] = p0[3] | C[3];
